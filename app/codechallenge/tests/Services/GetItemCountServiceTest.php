...
class GetItemCountServiceTest extends KernelTestCase
{
  private $getItemCountService;
  ...
  protected function setUp(): void
  {
    ...
    $this->getItemCountService = $container->get(GetItemCountService::class);
  ...
  public function canGetItemCount()
  {
    ...
    $this->assertEquals($quantity, $this->getItemCountService->execute($this->user->id()));
